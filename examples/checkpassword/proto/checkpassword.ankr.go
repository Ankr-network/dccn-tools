...
type Response struct {
	Rsp                  *RspCodeMsg `protobuf:"bytes,1,opt,name=rsp,proto3" json:"rsp,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Response) GetRsp() *RspCodeMsg {
	if m != nil {
		return m.Rsp
	}
	return nil
...
func (*RspCodeMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_16b233f109744c3c, []int{2}
}
...
func init() {
	...
	proto.RegisterType((*RspCodeMsg)(nil), "checkpassword.RspCodeMsg")
}
...
var fileDescriptor_16b233f109744c3c = []byte{
	...
	,
}
